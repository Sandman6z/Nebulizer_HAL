...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PluginCheck_GPIO_Port, PluginCheck_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : LED_Normal_Pin LED_Alarm_Pin */
  GPIO_InitStruct.Pin = LED_Normal_Pin|LED_Alarm_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_15mins_Pin LED_Proc1_Pin LED_Proc2_Pin LED_Proc3_Pin
  ...
  /*Configure GPIO pin : PluginCheck_Pin */
  GPIO_InitStruct.Pin = PluginCheck_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PluginCheck_GPIO_Port, &GPIO_InitStruct);
